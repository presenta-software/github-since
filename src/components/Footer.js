...
const Footer = () => {
  return (
    <footer>
      <p>This tool uses <a href='https://www.presenta.cc'>PRESENTA Editor and API</a> for the template and image generation<br />and the public API of GitHub for the user informations.</p>
